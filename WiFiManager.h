...
const char HTTP_STYLE[] PROGMEM           = "<style>.c{text-align: center;} div,input{padding:5px;font-size:1em;} input[type=text],input[type=password]{width:95%;} body{text-align: center;font-family:verdana;} button{border:0;border-radius:0.3rem;background-color:#1fa3ec;color:#fff;line-height:2.4rem;font-size:1.2rem;width:100%;} .cb{float: right;width: 47px;text-align: right;} .q{float: right;width: 64px;text-align: right;} .l{background: url(\"data:image/png;base64,\") no-repeat left center;background-size: 1em;}</style>";
...
const char HTTP_FORM_START[] PROGMEM      = "<form method='get' action='wifisave'><input type='text' id='s' name='s' length=32 placeholder='SSID'><br/><input id='p' name='p' length=64 type='password' placeholder='WLAN-Key'><br/>";
const char HTTP_FORM_PARAM_INPUT[] PROGMEM= "<br/><input type='text' id='{i}' name='{n}' length={l} placeholder='{p}' value='{v}' {c}>";
const char HTTP_FORM_PARAM_CKB[] PROGMEM   = "<br/>{p}<span class='cb'><input id='{i}' type=\"checkbox\" name='{n}' {v} value=1></span>";
const char HTTP_FORM_PARAM_COB[] PROGMEM   = "<br/>{p}<span class='cb'><select id='{i}' name=\"{n}\">{c}</select></span>";
