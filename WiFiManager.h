...
const char HTTP_SCRIPT[] PROGMEM          = "<script>function c(l){document.getElementById('s').value=l.innerText||l.textContent;document.getElementById('p').focus();} function setBackendType() { var backendtype = document.getElementById('backendtype'); if (backendtype) { var loxusername = document.getElementById('div_loxusername'); var loxpassword = document.getElementById('div_loxpassword'); var loxudpport = document.getElementById('div_loxudpport'); var ccu = document.getElementById('ccu'); var sonoff = document.getElementById('sonoff'); if (backendtype.value == 1) { if (loxusername) loxusername.style.display = 'block'; if (loxpassword) loxpassword.style.display = 'block'; if (loxudpport) loxudpport.style.display = 'block'; if (ccu) ccu.placeholder = 'IP:Port des LOXONE Miniservers'; if (sonoff) sonoff.placeholder = 'Sonoff DeviceName'; } else { if (loxusername) loxusername.style.display = 'none'; if (loxpassword) loxpassword.style.display = 'none'; if (loxudpport) loxudpport.style.display = 'none'; if (ccu) ccu.placeholder = 'IP der CCU2'; if (sonoff) sonoff.placeholder = 'Sonoff DeviceName'; }}}</script>";
