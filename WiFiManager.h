...
const char HTTP_FORM_START[] PROGMEM      = "<form method='get' action='wifisave'><input type='text' id='s' name='s' length=32 placeholder='SSID'><br/><input type='text' id='p' name='p' length=64 type='password' placeholder='WLAN-Key'><br/>";
